...
public class WorldPresetDataProvider extends TagsProvider<WorldPreset> {
    ...
    public WorldPresetDataProvider(
        ...
        super(output, Registries.WORLD_PRESET, registriesFuture, "bclib", existingFileHelper);
    }
    ...
    protected void addTags(HolderLookup.Provider arg) {
        final TagsProvider.TagAppender<WorldPreset> builder = tag(WorldPresetTags.NORMAL);
        builder.add(TagEntry.element(PresetsRegistry.BCL_WORLD.location()));
        builder.add(TagEntry.element(PresetsRegistry.BCL_WORLD_AMPLIFIED.location()));
        builder.add(TagEntry.element(PresetsRegistry.BCL_WORLD_LARGE.location()));
    }
}
