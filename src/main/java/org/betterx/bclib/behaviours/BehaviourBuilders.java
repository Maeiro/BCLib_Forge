...
public class BehaviourBuilders {
    private static final BlockBehaviour.StateArgumentPredicate<EntityType<?>> OCELOT_OR_PARROT =
            (state, getter, pos, entityType) -> entityType == EntityType.OCELOT || entityType == EntityType.PARROT;
    private static final BlockBehaviour.StateArgumentPredicate<EntityType<?>> NEVER_SPAWN =
            (state, getter, pos, entityType) -> false;
    private static final BlockBehaviour.StatePredicate NEVER =
            (state, getter, pos) -> false;
