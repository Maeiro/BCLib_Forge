...
public class EquipmentDescription<I extends Item> {
    ...
    public void init(
        ...
        RecipeDataProvider.defer(() -> addRecipe(id, item, material, stick, sourceSet));
    }
    ...
    public void addRecipe(
        ...
        if (tool == Items.AIR) return;
        if (ForgeRegistries.ITEMS.getKey(tool) == null) return;
