...
public abstract class HumanoidArmorRenderer {
    ...
    protected void renderModel(
        ...
        humanoidModel.renderToBuffer(pose, vertexConsumer, light, OverlayTexture.NO_OVERLAY, r, g, b, a);
    }
    ...
    protected void renderGlint(
        ...
        humanoidModel.renderToBuffer(
                pose, buffer.getBuffer(RenderType.armorEntityGlint()), light, OverlayTexture.NO_OVERLAY, 1.0f, 1.0f, 1.0f, 1.0f
        );
    }
